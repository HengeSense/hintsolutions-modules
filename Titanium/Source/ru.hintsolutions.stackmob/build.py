...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ru.hintsolutions.stackmob.js')
	...
	f = os.path.join(cwd,'Classes','RuHintsolutionsStackmobModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ru.hintsolutions.stackmob.js']
